...
function Options() {
  ...
  /** Functions called after the test completes. */
  this._chained = []
...
Options.prototype.evaluateWithJsonBody = function (fn) {
  this.evaluate(function (test, res) {
    var json = this._getJson(test, res)
    if (json == null) {
      return
    }
    fn(test, json)
...
Options.prototype._getJson = function (test, res) {
...
Options.prototype._copy = function (source) {
  ...
  this._chained = source._chained.concat()
